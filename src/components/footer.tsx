    ...
    <footer className="border-t bg-muted/40 mt-20">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div>
            <h3 className="font-semibold mb-6 text-foreground tracking-wide">{t("footer.features")}</h3>
          ...
          <div>
            <h3 className="font-semibold mb-6 text-foreground tracking-wide">{t("footer.support")}</h3>
            <ul className="space-y-4 text-sm text-muted-foreground">
          ...
          <div>
            <h3 className="font-semibold mb-6 text-foreground tracking-wide">{t("footer.legal")}</h3>
            <ul className="space-y-4 text-sm text-muted-foreground">
        ...
        <div className="mt-16 border-t pt-8 text-center flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
